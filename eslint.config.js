...
const ENFORCED_PATHS = [
  ...
  // Phase A, pass 7: the rest of the customer-facing app.
  "src/components/productivity/**/*.tsx",
  "src/components/coach/**/*.tsx",
  "src/components/hacs/**/*.tsx",
  ...
  "src/components/ReportStatusPage.tsx",
  "src/components/User360Dashboard.tsx",
