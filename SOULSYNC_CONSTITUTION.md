# SoulSync — Product Constitution & Wiring Roadmap (v3.12)

*Hand this to any AI developer session before it touches code.*

*v3.12 — THE SPLIT (founder, Jul 30 2026). The engineering rules moved out to
SOULSYNC_RUNTIME_CONSTITUTION.md. No product law changed; what changed is that
governance of the implementation is no longer interleaved with philosophy of the
product. The last act before the constitution freeze: from here, new law emerges
from implementation evidence or user testing, not from discussion.*
...
## 7-8. Moved to the Runtime Constitution

*Rules of engagement (former §7) and the open bug tally (former §8) now live in
**SOULSYNC_RUNTIME_CONSTITUTION.md**. They answer a different question than this
document — not "what should the Twin do" but "who is allowed to decide what the
Twin does" — and interleaving the two is part of how the implementation became
stratigraphy.*

*This is a move, not a copy: the text is not duplicated here. Rule 4 was amended
in the move ("Never delete services/hooks; unroute or unmount" → **Replacement
completes**), because that rule was the codified cause of the drift three audits
found. Read both documents at session start; the Runtime Constitution governs
ownership, jurisdiction and replacement, this one governs the product.*
