...
const ErrorBoundaryContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-soul-purple/10 via-white to-soul-teal/5 flex items-center justify-center p-4">
      <div className="bg-white/80 backdrop-blur-lg ss-r p-8 shadow-2xl border border-white/20 text-center max-w-md w-full">
        <div className="w-16 h-16 bg-red-100 rounded-full mx-auto mb-6 flex items-center justify-center">
          <AlertTriangle className="h-8 w-8 text-red-600" />
        </div>
        <h1 className="text-xl font-bold mb-3 text-gray-800">
          {t('system.errorOccurred')}
        </h1>
        ...
        <Button 
          ...
          className="w-full bg-gradient-to-r from-soul-purple to-soul-teal hover:shadow-lg transition-all duration-300 ss-r h-12 text-white font-medium"
        >
