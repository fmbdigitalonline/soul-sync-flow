...
export const InteractiveJourneyOverview: React.FC<InteractiveJourneyOverviewProps> = ({
  ...
  return (
    <div className={`bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg border border-white/20 transition-all duration-500 w-full max-w-full overflow-hidden ${spacing.card} ${
      ...
      <div className={`text-center mb-4 w-full max-w-full overflow-hidden ${isFoldDevice ? 'mb-2' : ''}`}>
      ...
      <div className={`flex flex-col w-full max-w-full space-y-3 overflow-hidden ${isFoldDevice ? 'space-y-2' : ''}`}>
        <button
        ...
        >
          <div className={`flex items-center w-full max-w-full gap-3 overflow-hidden ${isFoldDevice ? 'gap-2' : ''}`}>
