...
export function HomeMenuGrid({ items, className, ...props }: HomeMenuGridProps) {
  return (
    <section
      ...
      {...props}
    >
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 max-[360px]:grid-cols-1">
            ...
            <CosmicCard variant="minimal" size="lg" floating className="h-full p-0 overflow-hidden rounded-2xl">
              <article className="relative w-full min-h-[220px] sm:min-h-[260px] lg:min-h-[300px]">
                <div className="absolute inset-0 flex flex-col">
                  ...
                  <div className="flex-shrink-0 bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/80 p-3 sm:p-4">
