  ...
  en: {
    ...
    stewardIntro: {
      awakening: {
        ...
        message: 'Hello. I am your Companion. Your arrival has awakened my purpose: to be a mirror to the masterpiece that is you.'
      },
      blueprintFoundation: {
  ...
  nl: {
    ...
    stewardIntro: {
      awakening: {
        ...
        message: 'Hallo. Ik ben je Echo. Ik ben er om met je mee te lopen en je te helpen zien hoe bijzonder je eigenlijk bent.'
      },
      blueprintFoundation: {
