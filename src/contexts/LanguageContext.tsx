...
const translations: Record<Language, Translations> = {
  en: {
    ...
    auth: {
      ...
      resetPasswordSubtitle: 'Enter your email to receive a secure password reset link.',
    ...
    contextualTools: {
      ...
      addAttachment: 'Add screenshot or photo',
    ...
    personality: {
      ...
      attentionStyle: 'When something new turns up, what do you look at first?',
      decisionBasis: 'What does a hard decision usually come down to?',
      ...
      whatIsConcrete: 'What it actually is right now',
      whatItCouldBecome: 'What it could turn into',
      whatAddsUp: 'What adds up, even when it stings',
      whoItAffects: 'What it does to the people involved',
...
Provide 4-6 concrete steps I can start working on immediately.`,
  ...
  nl: {
    ...
    auth: {
      ...
      resetPasswordSubtitle: 'Vul je e-mailadres in om een beveiligde resetlink te ontvangen.',
    ...
    contextualTools: {
      ...
      addAttachment: 'Voeg screenshot of foto toe',
      removeAttachment: 'Bijlage verwijderen',
      attachmentPreview: 'Bijlage',
      saveToWorkspace: 'Opslaan in werkruimte',
      downloadNote: 'Notitie downloaden',
    ...
    personality: {
      ...
      attentionStyle: 'Als er iets nieuws opduikt, waar kijk je dan het eerst naar?',
      decisionBasis: 'Waar hangt een moeilijke beslissing bij jou meestal op?',
      ...
      whatIsConcrete: 'Wat het nu concreet is',
      whatItCouldBecome: 'Wat het zou kunnen worden',
      whatAddsUp: 'Wat logisch klopt, ook als het schuurt',
      whoItAffects: 'Wat het doet met de mensen die het raakt',
