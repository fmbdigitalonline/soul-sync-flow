...
const translations: Record<Language, Translations> = {
  en: {
    ...
    personality: {
      ...
      attentionStyle: 'What do you notice first?',
      decisionBasis: 'What settles a hard choice?',
      ...
      whatIsConcrete: 'What is actually there',
      whatItCouldBecome: 'What it could become',
      whatAddsUp: 'What adds up logically',
      whoItAffects: 'What it does to people',
...
Provide 4-6 concrete steps I can start working on immediately.`,
  ...
  nl: {
    ...
    personality: {
      ...
      attentionStyle: 'Wat valt jou het eerst op?',
      decisionBasis: 'Waar hangt een lastige keuze op?',
      ...
      whatIsConcrete: 'Wat er concreet is',
      whatItCouldBecome: 'Wat het kan worden',
      whatAddsUp: 'Wat logisch klopt',
      whoItAffects: 'Wat het met mensen doet',
