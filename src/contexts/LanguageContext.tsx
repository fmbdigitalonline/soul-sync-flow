...
const translations = {
  en: {
    ...
    'personality.outOfStars': '{{rating}} out of 5 stars',
    'personality.continueWithProfile': 'Continue with this profile',
    'personality.processing': 'Processing...',
    'personality.keepRefining': 'Don\'t worry - we\'ll keep refining this as you use the app!',
    'personality.confidence': '{{confidence}}% sure',
  ...
  nl: {
    ...
    // Personality Quiz
    'personality.energySource': 'Ik laad het beste op wanneer...',
    'personality.workspaceStyle': 'Mijn werkruimte is meestal...',
    'personality.planningStyle': 'Een weekendtrip plannen, ik...',
    'personality.beingAlone': 'Alleen zijn 🧘',
    'personality.beingWithPeople': 'Bij mensen zijn 🎉',
    'personality.tidyOrganized': 'Netjes & georganiseerd 📐',
    'personality.creativeChaos': 'Creatieve chaos 🎨',
    'personality.bookInAdvance': 'Alles van tevoren boeken',
    'personality.seeWhatHappens': 'Kijken wat er op de dag gebeurt',
    'personality.quickQuestion': 'Snelle vraag {{current}} van {{total}}',
    'personality.yourPersonalityProfile': 'Je Persoonlijkheidsprofiel',
    'personality.likelyStyle': 'Waarschijnlijke Stijl:',
    'personality.topMbtiMatches': 'Top MBTI matches:',
    'personality.howAccurate': 'Hoe accuraat voelt dit?',
    'personality.notQuiteRight': 'Niet helemaal juist',
    'personality.spotOn': 'Helemaal goed!',
    'personality.outOfStars': '{{rating}} van de 5 sterren',
    'personality.continueWithProfile': 'Ga verder met dit profiel',
    'personality.processing': 'Verwerken...',
    'personality.keepRefining': 'Maak je geen zorgen - we blijven dit verfijnen terwijl je de app gebruikt!',
    'personality.confidence': '{{confidence}}% zeker',
