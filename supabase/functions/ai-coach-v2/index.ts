// ==============================================
// AI COACH V2 - NUCLEAR REDEPLOYMENT
// VERSION: 2.2.0
// DEPLOYMENT: 2025-10-06T16:00:00Z
// MODEL: gpt-4.1-mini-2025-04-14 (QUOTA-SAFE)
// REASON: Force new function to bypass deployment cache
// ==============================================

import { serve } from "https://deno.land/std@0.168.0/http/server.ts"

const DEPLOYMENT_VERSION = "2.2.0";
const DEPLOYMENT_TIMESTAMP = "2025-10-06T16:00:00Z";
const DEPLOYMENT_MODEL = "gpt-4.1-mini-2025-04-14";
const FUNCTION_NAME = "ai-coach-v2";
...
console.log('🚀 AI-COACH-V2 INITIALIZED (NUCLEAR DEPLOYMENT):', {
  functionName: FUNCTION_NAME,
  version: DEPLOYMENT_VERSION,
  timestamp: DEPLOYMENT_TIMESTAMP,
  model: DEPLOYMENT_MODEL,
  status: 'FRESH_NEW_FUNCTION'
});

serve(async (req) => {
  // Version verification endpoint (GET request)
  if (req.method === 'GET') {
    console.log('📋 VERSION CHECK REQUEST to', FUNCTION_NAME);
    return new Response(
      JSON.stringify({
        functionName: FUNCTION_NAME,
        version: DEPLOYMENT_VERSION,
  ...
  try {
    ...
    console.log('🔥 AI-COACH-V2 REQUEST:', {
      functionName: FUNCTION_NAME,
      version: DEPLOYMENT_VERSION,
      deployedAt: DEPLOYMENT_TIMESTAMP,
...
INTEGRATION: Help ${userDisplayName} achieve goals while staying authentic to their inner wisdom.`;
    ...
    const finalTemperature = undefined; // GPT-4.1-mini doesn't support temperature
    const finalMaxTokens = maxTokens !== undefined 
      ? maxTokens 
      : (context === 'razor_aligned_goal_decomposition' ? 3000 : 2000);

    console.log('🎯 FINAL MODEL CONFIG (V2):', {
      functionName: FUNCTION_NAME,
      version: DEPLOYMENT_VERSION,
      model: selectedModel,
    ...
    console.log('📤 SENDING TO OPENAI (V2):', {
    ...
    if (!response.ok) {
      ...
      console.error('🚨 OpenAI API Error (V2):', {
    ...
    console.log('✅ AI-COACH-V2 SUCCESS:', {
      functionName: FUNCTION_NAME,
      version: DEPLOYMENT_VERSION,
      model: selectedModel,
    ...
    console.error('❌ AI-COACH-V2 Error:', {
      functionName: FUNCTION_NAME,
