...
serve(async (req) => {
  ...
  try {
    ...
    console.log('💼 Career Vocational Analyst: Processing analysis...');

    const prompt = `
As the Career Vocational Analyst, analyze professional archetypes, leadership styles, and career fulfillment patterns:
...
- Career archetypes and vocational calling patterns
- Natural leadership and management styles
- Team dynamics and collaboration preferences
- Work environment optimization
- Professional development pathways
- Career transition strategies and timing
`;
    ...
    console.log('✅ Career Vocational Analysis completed, length:', content.length);
